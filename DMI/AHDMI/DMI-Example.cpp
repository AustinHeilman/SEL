...
#if DMITOOL == 0 // Change to the number that the tool uses

#pragma message("----------")
#pragma message("** COMPILING FOR DESCRIPTION.EXE HANDLING **")
#pragma message("----------")
...
DMIKeys ReadDMIDefaults(DMIKeys &dmi_keys)
{
	...
	dmi_keys.append(DMIKey("SWMCODE", retval.substr(12, retval.length()))); //12-length
