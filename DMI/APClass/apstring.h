...
class apstring
{
	public:
		...
		int rfind(const apstring &str) const;
		int find_first_of(const apstring& str, int begin=0);
		int find_first_not_of(const apstring& str, int begin=0);
		int find_last_of(const apstring& str);
		int find_last_not_of(const apstring& str);
		...
		apstring& append(const apstring& str);
		apstring& append(const apstring& str, int index, int len);

		int compare(const apstring& str);

		bool empty() const;

		void swap(apstring &from);

		void Pad(char pad, int num);
