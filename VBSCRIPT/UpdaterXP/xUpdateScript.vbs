...
Const LAST_MODIFIED = "5/22/2007 8:33:29am (Austin Heilman)"
...
Call DoHeader()
WScript.Echo "| VAIO (XP) Updater (v"&VERSION_ID&") "
...
Function SetProxy(ByRef win_shell)
	...
	'obj_ie.Quit
	Call DoHeader()
	result = RunExec(win_shell, "netsh.exe diag connect ieproxy")
...
Function RemoveProxy(ByRef win_shell)
	...
	Call DoHeader()
	result = RunExec(win_shell, "netsh.exe diag connect ieproxy")
	'result = RunExec(win_shell, "netsh.exe winsock reset")
